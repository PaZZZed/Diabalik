...
QT_MOC_LITERAL(1, 15, 6), // "replay"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "GameOverWindow\0replay\0"
};
...
void GameOverWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GameOverWindow *_t = static_cast<GameOverWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject GameOverWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GameOverWindow.data,
      qt_meta_data_GameOverWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GameOverWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameOverWindow.stringdata0))
        return static_cast<void*>(const_cast< GameOverWindow*>(this));
